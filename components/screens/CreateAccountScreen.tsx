    ...
    <div className="screen flex flex-col h-full bg-white">
      <div className="flex-1 px-6">
        ...
        <div className="mt-8">
          ...
          <p className="text-[#606060] text-[16px] tracking-[-0.48px] leading-[1.5] mt-4 w-[290px]">
            Welcome to SwypeJobs — where you find the right job to match your swype.
          </p>
        </div>

        {/* Phone */}
        <div className="mt-10 flex flex-col gap-[8px]">
          <p className="text-[#606060] text-[14px] tracking-[-0.42px]">Phone number</p>
          <div className="flex gap-2 items-center">
            <div className="bg-[#f6f6f6] border border-[#e8e8e8] rounded-full px-4 py-[14px] flex items-center gap-2 flex-shrink-0">
              <span className="text-[13px]">🇳🇬</span>
              <span className="text-black text-[14px] tracking-[-0.42px]">+234</span>
            ...
            <input
              type="tel"
              placeholder="0916 137 9900"
              value={phone}
              onChange={e => setPhone(e.target.value)}
              className="flex-1 bg-[#f6f6f6] border border-[#e8e8e8] rounded-full px-4 py-[14px] text-[14px] tracking-[-0.42px] text-black placeholder-[#b0b0b0] outline-none focus:border-brand transition-colors"
            />
          </div>
        </div>
        ...
        <div className="mt-8 flex items-center gap-3">
          ...
          <span className="text-[#b0b0b0] text-[12px] tracking-[-0.36px]">or sign up with</span>
          <div className="flex-1 h-px bg-[#f0f0f0]" />
        </div>
      ...
      <div className="px-6 pb-10 bg-white">
        ...
        <p className="text-center text-[12px] text-[#b0b0b0] tracking-[-0.36px] mt-4 px-4">
          By continuing, you agree to our{' '}
          <span className="text-[#606060]">Terms of Service</span> and{' '}
          <span className="text-[#606060]">Privacy Policy</span>
        </p>
      </div>
    </div>
  )
